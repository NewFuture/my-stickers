...
export const common = {
    ...
    shortTitle: "Sticker",
    description: "Save and send your own stickers in Microsoft Teams.",
    langSetting: "切换语言",
    date: "{{date, time-ago}}",
...
export const home = {
    ...
    protoMsgExtStep1: "Click or hover on the next message",
    protoMsgExtStep2: "Click <0/> (more icon, the right one of the reactions)",
    protoMsgExtStep3: "Click <0/>(the last button in the menu list)",
    protoMsgExtStep4: "Click <0/>",
    protoMsgExtTime: "Yesterday, 11:33PM",
    ...
    protoMsgExtStickerSavedTitle: "Stickers are saved",
    // Compose Extension
    ...
    protoComposeIntro: "You can send your own stickers, After you install this extension. ❤",
    protoComposeIntroTip: "You may need to PIN it to the edit bar, from more extensions icons(...), by left click.",
...
export const config = {
    ...
    inputeTitle: "Edit the sticker's name",
    inputePlaceholder: "Input a name for search",
}